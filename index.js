...
app.get('/runCount', function (req, res) {
  console.log(req.query);
...
app.post('/create', function (req, res) {
  console.log("CREATE: " + req.body.username + " " + req.body.password + " " + req.body.mail);
  ...
  if (dbHelper.insertRunnerImageTest(req.body.username, req.body.name, req.body.password, req.body.age, req.body.phonenumber, req.body.mail, req.body.runcount, req.body.title, req.body.imageData, req.body.state)) {
    res.setHeader('Content-Type', 'application/json');
    res.end(JSON.stringify({ auth: true }, null, 3));
  }
})
